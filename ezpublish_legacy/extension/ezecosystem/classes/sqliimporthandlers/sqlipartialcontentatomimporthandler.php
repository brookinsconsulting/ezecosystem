<?php
/**
 * File containing demo import handler SQLIPartialContentATOMImportHandler
...
class SQLIPartialContentATOMImportHandler extends SQLIImportAbstractHandler implements ISQLIImportHandler
{
    ...
    public function process( $row )
    {
        ...
        $message = str_replace( 'href="/', 'href="http://partialcontent.com/', $message );
        $message = str_replace( 'img src="/', 'img src="http://partialcontent.com/', $message );
        $content->fields->blog_post_description_text_block = $message; // Proxy method to SQLIContentUtils::getRichContent()
    ...
    {
        return 'Partial Content ATOM Import Handler';
    }
    ...
    {
        return 'partialcontentatomimporthandler';
    }
