<?php
/**
 * File containing the eZContentObjectTreeNodeNoLanguage class.
 *
 ...
 * @package kernel
 */
class eZContentObjectTreeNodeNoLanguage extends eZPersistentObject
{
     ...
     * @param int|array $row
     */
    function eZContentObjectTreeNodeNoLanguage( $row = array() )
    {
    ...
    static function definition()
    {
        static $definition = array( "fields" => array( "node_id" => array( 'name' => "NodeID",
                                         ...
                                         "parent_node_id" => array( 'name' => "ParentNodeID",
                                                                    ...
                                                                    'default' => 0,
                                                                    'required' => true,
                                                                    'foreign_class' => 'eZContentObjectTreeNodeNoLanguage',
                      ...
                      "class_name" => "eZContentObjectTreeNodeNoLanguage",
     ...
     *
     * @return eZContentObjectTreeNodeNoLanguage
     */
                      ...
                      $sortField = 0, $sortOrder = true )
    {
        $row = array( 'node_id' => null,
                      ...
                      'priority' => 0 );
        $node = new eZContentObjectTreeNodeNoLanguage( $row );
        return $node;
    }
    ...
    static function fetchList( $asObject = true, $offset = false, $limit = false )
    {
        ...
        if ( $asObject )
        {
            foreach ( $rows as $row )
            {
                $nodes[] = new eZContentObjectTreeNodeNoLanguage( $row );
            }
            return $nodes;
        }
        else
                    ...
                    switch ( $sortField )
                    {
                        ...
                        case 'attribute':
                        {
                            ...
                            if ( !is_numeric( $classAttributeID ) )
                                $classAttributeID = eZContentObjectTreeNodeNoLanguage::classAttributeIDByIdentifier( $classAttributeID );
                            ...
                            $dataType = eZDataType::create( eZContentObjectTreeNodeNoLanguage::dataTypeByClassAttributeID( $classAttributeID ) );
                            ...
                            else
                            {
                                ...
                                $sortKeyType = eZContentObjectTreeNodeNoLanguage::sortKeyByClassAttributeID( $classAttributeID );
                                switch ( $sortKeyType )
                                {
                                    case 'string':
                                        {
                ...
                foreach ( $filterArray as $filter )
                {
                    ...
                    if ( $useAttributeFilter )
                    {
                        if ( !is_numeric( $filterAttributeID ) )
                            $filterAttributeID = eZContentObjectTreeNodeNoLanguage::classAttributeIDByIdentifier( $filterAttributeID );
                        ...
                        else
                        {
                            ...
                            $filterDataType = eZContentObjectTreeNodeNoLanguage::sortKeyByClassAttributeID( $filterAttributeID );
        ...
        if ( $groupBy )
        {
            if ( isset( $groupBy['field'] ) and isset( $groupBy['type'] ) )
            {
                ...
                switch ( $groupByField )
                {
                    case 'published':
                    {
                        $groupBySelect = eZContentObjectTreeNodeNoLanguage::subTreeGroupByDateField( "ezcontentobject." . $groupByField, $groupByFieldType );
    ...
    */
    ...
    static function subTreeByNodeID( $params = false, $nodeID = 0 )
    {
        ...
        $sortingInfo             = eZContentObjectTreeNodeNoLanguage::createSortingSQLStrings( $params['SortBy'], 'ezcontentobject_tree', $allowCustomSorting );
        $classCondition          = eZContentObjectTreeNodeNoLanguage::createClassFilteringSQLString( $params['ClassFilterType'], $params['ClassFilterArray'] );
        ...
        if ( $language )
        {
            ...
            // This call must occur after eZContentObjectTreeNodeNoLanguage::createPathConditionAndNotEqParentSQLStrings,
    ...
    */
    static function calendar( $params = false, $nodeID = 0 )
    {
        ...
        $classCondition          = eZContentObjectTreeNodeNoLanguage::createClassFilteringSQLString( $params['ClassFilterType'], $params['ClassFilterArray'] );
        $attributeFilter         = eZContentObjectTreeNodeNoLanguage::createAttributeFilterSQLStrings( $params['AttributeFilter'], $sortingInfo );
        $extendedAttributeFilter = eZContentObjectTreeNodeNoLanguage::createExtendedAttributeFilterSQLStrings( $params['ExtendedAttributeFilter'] );
        $mainNodeOnlyCond        = eZContentObjectTreeNodeNoLanguage::createMainNodeConditionSQLString( $mainNodeOnly );

        $pathStringCond     = '';
        $notEqParentString  = '';
        eZContentObjectTreeNodeNoLanguage::createPathConditionAndNotEqParentSQLStrings( $pathStringCond, $notEqParentString, $nodeID, $depth, $depthOperator );
    ...
    */
    function childrenByName( $name )
    {
        ...
        return eZContentObjectTreeNodeNoLanguage::makeObjectsArray(
            $db->arrayQuery(
                "SELECT " .
                "ezcontentobject.contentclass_id, ezcontentobject.current_version, ezcontentobject.id, ezcontentobject.initial_language_id, ezcontentobject.language_mask, " .
                "ezcontentobject.modified, ezcontentobject.owner_id, ezcontentobject.published, ezcontentobject.remote_id AS object_remote_id, " .
    ...
    */
    function sortArray()
    {
        return eZContentObjectTreeNodeNoLanguage::sortArrayBySortFieldAndSortOrder( $this->attribute( 'sort_field' ),
    ...
    */
    ...
    {
        return array( array( eZContentObjectTreeNodeNoLanguage::sortFieldName( $sortField ),
                              $sortOrder ) );
    }
    ...
    */
    static function assignSectionToSubTree( $nodeID, $sectionID, $oldSectionID = false )
    {
        ...
        eZAudit::writeAudit( 'section-assign', array( 'Section ID' => $sectionID, 'Section name' => $section->attribute( 'name' ),
                                                      ...
                                                      'Comment' => 'Assigned a section to the current node and all child objects: eZContentObjectTreeNodeNoLanguage::assignSectionToSubTree()' ) );
    ...
    */
    ...
    static function fetchByContentObjectID( $contentObjectID, $asObject = true, $contentObjectVersion = false )
    {
        ...
        return eZPersistentObject::fetchObjectList( eZContentObjectTreeNodeNoLanguage::definition(),
                                                    null,
                                                    $conds,
                                                    null,
                                                    null,
    ...
    {
        return eZContentObjectTreeNodeNoLanguage::fetch( false, false, $asObject, array( "remote_id" => $remoteID ) );
    }

    static function fetchByPath( $pathString, $asObject = true )
    {
        return eZContentObjectTreeNodeNoLanguage::fetch( false, false, $asObject, array( "path_string" => $pathString ) );
    }
    ...
    static function fetchByURLPath( $pathString, $asObject = true )
    {
        ...
        return eZContentObjectTreeNodeNoLanguage::fetch( false, false, $asObject, array( "path_identification_string" => $pathString ) );
    }
    ...
    static function findMainNode( $objectID, $asObject = false )
    {
        ...
        if ( count( $nodeListArray ) == 1 )
        {
            if ( $asObject )
            {
                 return eZContentObjectTreeNodeNoLanguage::fetch( $nodeListArray[0]['node_id'] );
            }
            else
            {
     ...
     * @param bool $asObject
     *        Wether to return the result as an array of eZContentObjectTreeNodeNoLanguage
     *        (true) or as an array of associative arrays (false)
     * @return array(array|eZContentObjectTreeNodeNoLanguage)
     */
    static function findMainNodeArray( $objectIDArray, $asObject = true )
    {
        ...
        if ( $asObject )
        {
            return eZContentObjectTreeNodeNoLanguage::makeObjectsArray( $nodeListArray );
        }
    ...
    */
    static function fetch( $nodeID = false, $lang = false, $asObject = true, $conditions = false )
    {
        ...
        if ( is_array( $nodeListArray ) && !empty( $nodeListArray ) )
        {
            if ( $asObject )
            {
                $returnValue = eZContentObjectTreeNodeNoLanguage::makeObjectsArray( $nodeListArray );
    ...
    /*!
     ...
     \return An eZContentObjectTreeNodeNoLanguage object or \c null if no node was found.
    */
    static function fetchNode( $contentObjectID, $parentNodeID )
    {
        ...
        if ( count( $nodeListArray ) == 1 )
        {
            $retNodeArray = eZContentObjectTreeNodeNoLanguage::makeObjectsArray( $nodeListArray, false );
    ...
    function fetchPath()
    {
        ...
        return eZContentObjectTreeNodeNoLanguage::fetchNodesByPathString( $nodePath, false, true );
    }
    ...
    */
    static function fetchNodesByPathString( $nodePath, $withLastNode = false, $asObjects = true, $limit = false )
    {
        ...
        $pathString = eZContentObjectTreeNodeNoLanguage::createNodesConditionSQLStringFromPath( $nodePath, $withLastNode, $limit );
        ...
        if ( $asObjects )
        {
            return eZContentObjectTreeNodeNoLanguage::makeObjectsArray( $nodesListArray );
        }
    ...
    */
    ...
    {
        $itemList = array();
        $nodes = eZContentObjectTreeNodeNoLanguage::fetchNodesByPathString( $nodePath, $withLastNode, false, $limit );
    ...
    function removeThis()
    {
        ...
        if ( eZAudit::isAuditEnabled() )
        {
            ...
            eZAudit::writeAudit( 'content-delete', array( 'Node ID' => $nodeID, 'Object ID' => $objectID, 'Content Name' => $objectName,
                                                          'Comment' => 'Removed the current node: eZContentObjectTreeNodeNoLanguage::removeNode()' ) );
        }
    ...
    */
    ...
    {
        return eZContentObjectTreeNodeNoLanguage::removeSubtrees( $deleteIDArray, true, true );
    }
    ...
    */
    static function removeSubtrees( $deleteIDArray, $moveToTrash = true, $infoOnly = false )
    {
        ...
        {
            $node = eZContentObjectTreeNodeNoLanguage::fetch( $deleteID );
            if ( $node === null )
                continue;
        ...
        return array( 'move_to_trash' => $moveToTrashAllowed,
                      ...
                      'reverse_related_count' => eZContentObjectTreeNodeNoLanguage::reverseRelatedCount( $deleteIDArray ) );
    }
    ...
    */
    static function reverseRelatedCount( $nodeIDArray )
    {
        ...
        {
            $contentObjectTreeNode = eZContentObjectTreeNodeNoLanguage::fetch( $nodeID, false, false );
    ...
    function removeNodeFromTree( $moveToTrash = true )
    {
        ...
        if ( $nodeID == $this->attribute( 'main_node_id' ) )
        {
            if ( count( $assignedNodes ) > 1 )
            {
                ...
                $db = eZDB::instance();
                $db->begin();
                eZContentObjectTreeNodeNoLanguage::updateMainNodeID( $newMainNode->attribute( 'node_id' ),
                                                           $object->attribute( 'id' ),
    ...
    */
    function move( $newParentNodeID, $nodeID = 0 )
    {
        ...
        if ( $oldParentNodeID != $newParentNodeID )
        {
            ...
            eZAudit::writeAudit( 'content-move', array( 'Node ID' => $node->attribute( 'node_id' ),
                                                        ...
                                                        'Comment' => 'Moved the node to the given node: eZContentObjectTreeNodeNoLanguage::move()' ) );

            $newParentNode = eZContentObjectTreeNodeNoLanguage::fetch( $newParentNodeID );
            ...
            $newNode = eZContentObjectTreeNodeNoLanguage::fetch( $nodeID );
            eZContentObjectTreeNodeNoLanguage::updateNodeVisibility( $newNode, $newParentNode );
            $db->commit();
        }
    }
    ...
    function checkAccess( $functionName, $originalClassID = false, $parentClassID = false, $returnAccessList = false, $language = false )
    {
        ...
        if ( $origFunctionName == 'can_remove_location' )
        {
            ...
            $currentNode = eZContentObjectTreeNodeNoLanguage::fetch( $this->ParentNodeID );
            if ( !$currentNode instanceof eZContentObjectTreeNodeNoLanguage )
            {
                return 0;
            }
    ...
    */
    ...
    static public function makeObjectsArray( $array , $with_contentobject = true, array $propertiesOverride = null )
    {
        ...
        foreach ( $array as $node )
        {
            ...
            $object = new eZContentObjectTreeNodeNoLanguage(
                array(
    ...
    {
        eZContentObjectTreeNodeNoLanguage::removeNode( eZContentObjectTreeNodeNoLanguage::findNode( $node, $id ) );
    ...
    */
    static function unserialize( $contentNodeDOMNode, $contentObject, $version, $isMain, &$nodeList, &$options, $handlerType = 'ezcontentobject' )
    {
        ...
        $nodeInfo = array( 'contentobject_id' => $contentObject->attribute( 'id' ),
                           ...
                           'sort_field' => eZContentObjectTreeNodeNoLanguage::sortFieldID( $contentNodeDOMNode->getAttribute( 'sort-field' ) ),
    ...
    */
     ...
     */
    static function hideSubTree( eZContentObjectTreeNodeNoLanguage $node, $modifyRootNode = true )
    {
        $nodeID = $node->attribute( 'node_id' );
        $time = time();
        $db = eZDB::instance();
        ...
        if ( eZAudit::isAuditEnabled() )
        {
            ...
            eZAudit::writeAudit( 'content-hide', array( 'Node ID' => $nodeID,
                                                        ...
                                                        'Time' => $time,
                                                        'Comment' => 'Node has been hidden: eZContentObjectTreeNodeNoLanguage::hideSubTree()' ) );
        }
    ...
    static function unhideSubTree( eZContentObjectTreeNodeNoLanguage $node, $modifyRootNode = true )
    {
        ...
        if ( eZAudit::isAuditEnabled() )
        {
            ...
            eZAudit::writeAudit( 'content-hide', array( 'Node ID' => $nodeID,
                                                        ...
                                                        'Content Name' => $objectName,
                                                        'Time' => $time,
                                                        'Comment' => 'Node has been unhidden: eZContentObjectTreeNodeNoLanguage::unhideSubTree()' ) );
        }
    ...
    {
        return eZContentObjectTreeNodeNoLanguage::availableClassListJsArray( array( 'node' => $this ) );
    }
    ...
    static function getClassesJsArray( $node = false, $includeFilter = true, $groupList = false, $fetchID = false, $classes = false )
    {
        ...
        if ( $classes === false )
        {
            ...
            $classes = ( $node instanceOf eZContentObjectTreeNodeNoLanguage )
