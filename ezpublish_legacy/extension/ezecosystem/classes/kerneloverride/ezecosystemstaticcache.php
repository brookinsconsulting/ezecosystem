<?php
/**
 * File containing the eZecosystemStaticCache class
 *
...
/**
 * The eZecosystemStaticCache class manages the static cache system.
 *
 ...
 *
 * <code>
 * $staticCache = new eZecosystemStaticCache();
 ...
 * @package kernel
 */
class eZecosystemStaticCache implements ezpStaticCache
{
    /**
     * User-Agent string
     */
    ...
    /**
     * Getter method for {@link eZecosystemStaticCache::$hostName}
     *
    ...
    /**
     * Getter method for {@link eZecosystemStaticCache::$staticStorageDir}
     *
    ...
    /**
     * Getter method for {@link eZecosystemStaticCache::$maxCacheDepth}
     *
    ...
    /**
     * Getter method for {@link eZecosystemStaticCache::$cachedSiteAccesses}
     *
    ...
    /**
     * Getter method for {@link eZecosystemStaticCache::$cachedURLArray}
     *
    ...
    /**
     * Getter method for {@link eZecosystemStaticCache::$alwaysUpdate}
     *
     * These URLs are configured with AlwaysUpdateArray in staticcache.ini.
     *
     * @see eZecosystemStaticCache::generateAlwaysUpdatedCache()
                ...
                foreach ( $cacheFiles as $file )
                {
                    ...
                    if ( !$skipUnlink || !file_exists( $file ) )
                    {
                        ...
                        else
                        {
                            ...
                            {
                                eZecosystemStaticCache::storeCachedFile( $file, $content );
                            }
                        }
                    }
                }
            ...
            switch( $action ) {
                case 'store':
                    ...
                    else
                    {
                        ...
                        {
                            if ( eZHTTPTool::getDataByURL( $source, true, eZecosystemStaticCache::USER_AGENT ) )
                                $fileContentCache[$source] = eZHTTPTool::getDataByURL( $source, false, eZecosystemStaticCache::USER_AGENT );
                            else
                        ...
                        {
                            eZecosystemStaticCache::storeCachedFile( $destination, $fileContentCache[$source] );
                            $doneDestList[$destination] = 1;
                        }
                    }
                    break;
