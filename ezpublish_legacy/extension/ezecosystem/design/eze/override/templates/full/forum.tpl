...
<div class="content-view-full">
    ...
    <div class="content-view-children">
        ...
        <tr>
            ...
            <th class="project">
                {"Project"|i18n( "design/ezwebin/full/forum" )}
            </th>
            <th class="lastreply">
                {"Published Date"|i18n( "design/ezwebin/full/forum" )}
            </th>
        </tr>
        ...
        {if $topic_count}
            ...
            <tr class="{$topic.sequence}">
                ...
                <td class="project">
                   {if $topic.object.data_map.link.content|contains('://projects.ez.no')}
                   <p class="date"><a href="{concat( 'http://projects.ez.no/', $topic.object.data_map.link.content|explode('://projects.ez.no/')[1]|explode('/')[0], '/' )}">{$topic.object.data_map.link.content|explode('://projects.ez.no/')[1]|explode('/')[0]}</a></p>
                   {else}
                   <p class="date">N/A</p>
                   {/if}
                </td>
                <td class="replies">
                    {$topic.object.published|l10n(shortdatetime)}
                </td>
                {*
                <td class="replies">
