    ...
    <div class="class-forum-topic">
        ...
        {/section}
            ...
            <tr>
                ...
                <th class="project">
                    {"Project"|i18n("design/ezwebin/full/forum_topic")}
                 </th>
            </tr>
            ...
            <tr class="bglight">
               ...
               <td class="message">
                ...
                <td class="project">
                   {if $node.object.data_map.link.content|contains('://projects.ez.no')}
                   <p class="date"><a href="{concat( 'http://projects.ez.no/', $node.object.data_map.link.content|explode('://projects.ez.no/')[1]|explode('/')[0], '/' )}">{$node.object.data_map.link.content|explode('://projects.ez.no/')[1]|explode('/')[0]}</a></p>
                   {else}
                   <p class="date">N/A</p>
                   {/if}
                </td>
