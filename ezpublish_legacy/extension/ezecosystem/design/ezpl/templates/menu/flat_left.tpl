{* <b>{ezini( 'MenuContentSettings', 'LeftIdentifierList', 'menu.ini' )|attribute(show,1)}</b> *}
...
{else}
{if and( $item.class_identifier|ne( 'link' ), $item.node_id|ne( ezini( 'NodeIDSettings', 'NotificationsNodeID', 'ezpublishlegacy.ini' ) ) )}
