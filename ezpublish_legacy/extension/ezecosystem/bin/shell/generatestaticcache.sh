...
# Refresh All Static Cache
## php ./extension/bcgeneratestaticcache/bin/php/bcgeneratestaticcache.php --subtree=$uri$subtree$children--force -s $siteaccess;
php -d memory_limit=-1 ./extension/bcgeneratestaticcache/bin/php/bcgeneratestaticcache.php --subtree=$uri --children --force --max-level=7 -s $siteaccess;
